...
#define AI_TOOLS_DATE_TIME   "Thu Jan  6 13:52:54 2022"
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(activations_map, 1, params)) {
    ...
    input_1_output_array.data = AI_PTR(activations_map[0] + 3772);
    input_1_output_array.data_start = AI_PTR(activations_map[0] + 3772);
    ...
    conv2d_2_scratch0_array.data = AI_PTR(activations_map[0] + 102080);
    conv2d_2_scratch0_array.data_start = AI_PTR(activations_map[0] + 102080);
    conv2d_2_scratch1_array.data = AI_PTR(activations_map[0] + 35504);
    conv2d_2_scratch1_array.data_start = AI_PTR(activations_map[0] + 35504);
    conv2d_2_output_array.data = AI_PTR(activations_map[0] + 35504);
    conv2d_2_output_array.data_start = AI_PTR(activations_map[0] + 35504);
    conv2d_3_scratch0_array.data = AI_PTR(activations_map[0] + 102680);
    conv2d_3_scratch0_array.data_start = AI_PTR(activations_map[0] + 102680);
    conv2d_3_scratch1_array.data = AI_PTR(activations_map[0] + 33424);
    conv2d_3_scratch1_array.data_start = AI_PTR(activations_map[0] + 33424);
    conv2d_3_output_array.data = AI_PTR(activations_map[0] + 33424);
    conv2d_3_output_array.data_start = AI_PTR(activations_map[0] + 33424);
    conv2d_4_scratch0_array.data = AI_PTR(activations_map[0] + 33280);
    conv2d_4_scratch0_array.data_start = AI_PTR(activations_map[0] + 33280);
    ...
    conv2d_5_scratch1_array.data = AI_PTR(activations_map[0] + 33280);
    conv2d_5_scratch1_array.data_start = AI_PTR(activations_map[0] + 33280);
    conv2d_5_output_array.data = AI_PTR(activations_map[0] + 33280);
    conv2d_5_output_array.data_start = AI_PTR(activations_map[0] + 33280);
    conv2d_7_scratch0_array.data = AI_PTR(activations_map[0] + 0);
    conv2d_7_scratch0_array.data_start = AI_PTR(activations_map[0] + 0);
    conv2d_7_scratch1_array.data = AI_PTR(activations_map[0] + 31696);
    conv2d_7_scratch1_array.data_start = AI_PTR(activations_map[0] + 31696);
    conv2d_7_output_array.data = AI_PTR(activations_map[0] + 31696);
    conv2d_7_output_array.data_start = AI_PTR(activations_map[0] + 31696);
    conv2d_8_scratch0_array.data = AI_PTR(activations_map[0] + 0);
    conv2d_8_scratch0_array.data_start = AI_PTR(activations_map[0] + 0);
    conv2d_8_output_array.data = AI_PTR(activations_map[0] + 272);
    conv2d_8_output_array.data_start = AI_PTR(activations_map[0] + 272);
    ...
    conv2d_9_scratch1_array.data = AI_PTR(activations_map[0] + 8976);
    conv2d_9_scratch1_array.data_start = AI_PTR(activations_map[0] + 8976);
    conv2d_9_output_array.data = AI_PTR(activations_map[0] + 58128);
    conv2d_9_output_array.data_start = AI_PTR(activations_map[0] + 58128);
    conv2d_10_scratch0_array.data = AI_PTR(activations_map[0] + 8464);
    conv2d_10_scratch0_array.data_start = AI_PTR(activations_map[0] + 8464);
    conv2d_10_scratch1_array.data = AI_PTR(activations_map[0] + 107280);
    conv2d_10_scratch1_array.data_start = AI_PTR(activations_map[0] + 107280);
    conv2d_10_output_array.data = AI_PTR(activations_map[0] + 156432);
    conv2d_10_output_array.data_start = AI_PTR(activations_map[0] + 156432);
    conv2d_11_scratch0_array.data = AI_PTR(activations_map[0] + 0);
    conv2d_11_scratch0_array.data_start = AI_PTR(activations_map[0] + 0);
    conv2d_11_output_array.data = AI_PTR(activations_map[0] + 8464);
    conv2d_11_output_array.data_start = AI_PTR(activations_map[0] + 8464);
    eltwise_12_output_array.data = AI_PTR(activations_map[0] + 16656);
    eltwise_12_output_array.data_start = AI_PTR(activations_map[0] + 16656);
    conv2d_13_scratch0_array.data = AI_PTR(activations_map[0] + 0);
    conv2d_13_scratch0_array.data_start = AI_PTR(activations_map[0] + 0);
    conv2d_13_scratch1_array.data = AI_PTR(activations_map[0] + 24848);
    conv2d_13_scratch1_array.data_start = AI_PTR(activations_map[0] + 24848);
    conv2d_13_output_array.data = AI_PTR(activations_map[0] + 74000);
    conv2d_13_output_array.data_start = AI_PTR(activations_map[0] + 74000);
