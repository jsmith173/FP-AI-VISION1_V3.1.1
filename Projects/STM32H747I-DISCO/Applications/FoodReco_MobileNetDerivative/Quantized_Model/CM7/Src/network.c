...
#define AI_TOOLS_DATE_TIME   "Thu Jan  6 13:52:29 2022"
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    ...
    134776, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 152008, 1, 1),
    152008, NULL, NULL),
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(activations_map, 1, params)) {
    ...
    quantize_input_2_output_array.data_start = AI_PTR(activations_map[0] + 904);
    quantize_conv1_conv2d_scratch0_array.data = AI_PTR(activations_map[0] + 151436);
    quantize_conv1_conv2d_scratch0_array.data_start = AI_PTR(activations_map[0] + 151436);
    quantize_conv1_conv2d_output_array.data = AI_PTR(activations_map[0] + 0);
    quantize_conv1_conv2d_output_array.data_start = AI_PTR(activations_map[0] + 0);
    quantize_conv_dw_1_conv2d_scratch0_array.data = AI_PTR(activations_map[0] + 100352);
    quantize_conv_dw_1_conv2d_scratch0_array.data_start = AI_PTR(activations_map[0] + 100352);
    quantize_conv_dw_1_conv2d_output_array.data = AI_PTR(activations_map[0] + 100572);
    quantize_conv_dw_1_conv2d_output_array.data_start = AI_PTR(activations_map[0] + 100572);
    ...
    quantize_conv_pw_1_conv2d_output_array.data_start = AI_PTR(activations_map[0] + 32);
    quantize_conv_dw_2_conv2d_scratch0_array.data = AI_PTR(activations_map[0] + 50208);
    quantize_conv_dw_2_conv2d_scratch0_array.data_start = AI_PTR(activations_map[0] + 50208);
    quantize_conv_dw_2_conv2d_output_array.data = AI_PTR(activations_map[0] + 50644);
    quantize_conv_dw_2_conv2d_output_array.data_start = AI_PTR(activations_map[0] + 50644);
    ...
    quantize_conv_pw_2_conv2d_output_array.data_start = AI_PTR(activations_map[0] + 64);
    quantize_conv_dw_3_conv2d_scratch0_array.data = AI_PTR(activations_map[0] + 25152);
    quantize_conv_dw_3_conv2d_scratch0_array.data_start = AI_PTR(activations_map[0] + 25152);
    quantize_conv_dw_3_conv2d_output_array.data = AI_PTR(activations_map[0] + 26020);
    quantize_conv_dw_3_conv2d_output_array.data_start = AI_PTR(activations_map[0] + 26020);
